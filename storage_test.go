...
func (s *TestingStorage) GetClient(id string, r *http.Request) (*Client, error) {
...
func (s *TestingStorage) SaveAuthorize(data *AuthorizeData, r *http.Request) error {
	s.authorize[data.Code] = data
	return nil
}

func (s *TestingStorage) LoadAuthorize(code string, r *http.Request) (*AuthorizeData, error) {
...
func (s *TestingStorage) RemoveAuthorize(code string, r *http.Request) error {
	delete(s.authorize, code)
	return nil
}

func (s *TestingStorage) SaveAccess(data *AccessData, r *http.Request) error {
...
func (s *TestingStorage) LoadAccess(code string, r *http.Request) (*AccessData, error) {
...
func (s *TestingStorage) RemoveAccess(code string, r *http.Request) error {
	delete(s.access, code)
	return nil
}

func (s *TestingStorage) LoadRefresh(code string, r *http.Request) (*AccessData, error) {
...
func (s *TestingStorage) RemoveRefresh(code string, r *http.Request) error {
